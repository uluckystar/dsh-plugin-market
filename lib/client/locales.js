...
export const zh = {
    ...
    secBadgeShort: '安全', secBadgeTip: '安全报告',
    secBlockedShort: '已禁用', secBlockedTip: '检测到恶意行为，已禁用',
...
export const en = {
    ...
    secBadgeShort: 'security', secBadgeTip: 'Security report',
    secBlockedShort: 'blocked', secBlockedTip: 'Blocked for malicious behavior',
