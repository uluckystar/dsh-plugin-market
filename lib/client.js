	...
	factory: (require) => {
		...
		*/
		...
		var MarketTab_module_css_default = {
			...
			"wrap": "HXRBOa_wrap",
			"restartRow": "HXRBOa_restartRow",
			"secBadgeHigh": "HXRBOa_secBadgeHigh",
			...
			"restartHint": "HXRBOa_restartHint",
			"searchInput": "HXRBOa_searchInput",
			"tabs": "HXRBOa_tabs",
			"btnRestart": "HXRBOa_btnRestart",
			"secBadge": "HXRBOa_secBadge",
		...
		function PluginRow(p, status, busy, onInstall, onEnable, onDisable, onUninstall, onAssess, t) {
			...
			const secBadge = sec ? sec.blocked ? (0, react_jsx_runtime.jsxs)("span", {
				className: `${MarketTab_module_css_default.secBadge} ${MarketTab_module_css_default.secBadgeBlock}`,
				title: t("secBlockedTip"),
				children: ["🚫 ", t("secBlockedShort")]
			}) : (0, react_jsx_runtime.jsxs)("span", {
				className: `${MarketTab_module_css_default.secBadge} ${(sec.risk_score ?? 0) >= 51 ? MarketTab_module_css_default.secBadgeHigh : (sec.risk_score ?? 0) >= 21 ? MarketTab_module_css_default.secBadgeMid : MarketTab_module_css_default.secBadgeOk}`,
				title: `${t("secBadgeTip")}(${sec.verdict ?? ""})`,
				children: [
					(sec.risk_score ?? 0) >= 81 ? "🔴" : (sec.risk_score ?? 0) >= 51 ? "🟠" : (sec.risk_score ?? 0) >= 21 ? "🟡" : "🟢",
					" ",
					t("secBadgeShort"),
					" ",
					sec.risk_score ?? "—"
		...
		function MarketTab({ search, browse, install, uninstall, enable, disable, status, lifecycle, restart, assess, installed, t }) {
			...
			const [restartPendingFor, setRestartPendingFor] = (0, react.useState)(null);
			...
			const handleRestartNow = async () => {
				...
				try {
					...
					while (Date.now() < deadline) {
						...
						try {
							if ((await fetch("/api/plugin-market/lifecycle", {
								method: "POST",
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					restartPendingFor !== null && !restarting ? (0, react_jsx_runtime.jsxs)("div", {
						className: MarketTab_module_css_default.restartRow,
						children: [(0, react_jsx_runtime.jsx)("span", {
							className: MarketTab_module_css_default.restartHint,
							children: t(`restartCap_${lifecycleState?.restartCapability ?? "manual"}`)
						}), (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: MarketTab_module_css_default.btnRestart,
							onClick: () => void handleRestartNow(),
							children: t("restartNow")
						})]
					}) : null,
					restarting ? (0, react_jsx_runtime.jsxs)("div", {
						className: MarketTab_module_css_default.restartRow,
						children: [(0, react_jsx_runtime.jsx)("span", {
							className: MarketTab_module_css_default.restartHint,
							children: t("restarting")
						}), (0, react_jsx_runtime.jsx)("span", {
							className: MarketTab_module_css_default.restartSpinner,
							children: "⏳"
						})]
					}) : null,
		...
		const zh = {
			...
			secBadgeTip: "安全报告",
			secBlockedShort: "已禁用",
			secBlockedTip: "检测到恶意行为，已禁用",
			secBlockedInstall: "该插件已被安全评估判定为恶意并禁用，无法安装。",
			assessPending: "待人工复核",
			stars: "Star",
			lang: "语言",
			noDesc: "暂无简介",
		...
		const en = {
			...
			secBadgeShort: "security",
			secBadgeTip: "Security report",
			secBlockedShort: "blocked",
			secBlockedTip: "Blocked for malicious behavior",
			secBlockedInstall: "This plugin was blocked as malicious by security review and cannot be installed.",
