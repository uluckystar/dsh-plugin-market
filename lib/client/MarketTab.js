...
function statusActions(p, status, busy, onInstall, onEnable, onDisable, onUninstall, onAssess, t) {
    ...
    switch (status) {
        ...
        case 'enabled-restart':
            push(_jsx("button", { type: "button", className: css.btnDisable, disabled: busy?.uninstalling === true, onClick: () => onDisable(p.full_name), children: t('disable') }, "d"));
            push(_jsx("button", { type: "button", className: css.btnUninstall, disabled: busy?.uninstalling === true, onClick: () => onUninstall(p.full_name), children: t('uninstall') }, "u"));
            break;
        case 'disabled-restart':
            push(_jsx("button", { type: "button", className: css.btnEnable, disabled: busy?.installing === true, onClick: () => onEnable(p.full_name), children: t('enable') }, "e"));
            push(_jsx("button", { type: "button", className: css.btnUninstall, disabled: busy?.uninstalling === true, onClick: () => onUninstall(p.full_name), children: t('uninstall') }, "u"));
            break;
        case 'installed':
            push(_jsx("button", { type: "button", className: css.btnEnable, disabled: busy?.installing === true, onClick: () => onEnable(p.full_name), children: t('enable') }, "e"));
        ...
        case 'incompatible':
            ...
            break;
        case 'install-failed':
            push(_jsx("button", { type: "button", className: css.btnInstall, disabled: busy?.installing === true, onClick: () => onInstall(p.full_name), children: t('retryInstall') }, "i"));
            push(_jsx("button", { type: "button", className: css.btnUninstall, disabled: busy?.uninstalling === true, onClick: () => onUninstall(p.full_name), children: t('uninstall') }, "u"));
            break;
        default:
            push(_jsx("button", { type: "button", className: css.btnInstall, disabled: busy?.installing === true, onClick: () => onInstall(p.full_name), children: t('install') }, "i"));
    }
    push(_jsx("button", { type: "button", className: css.btnAssess, disabled: busy?.assessing === true, onClick: () => onAssess(p.full_name), children: t('assess') }, "a"));
