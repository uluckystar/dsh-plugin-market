				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [p.full_name, p.installed ? (0, react_jsx_runtime.jsx)("span", {
								className: MarketTab_module_css_default.tagInstalled,
					...
					children: [p.installed ? (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						...
						children: busy?.installing ? t("installing") : t("install")
					}), (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: MarketTab_module_css_default.btnAssess,
						disabled: busy?.assessing === true,
						onClick: () => onAssess(p.full_name),
						children: busy?.assessing ? t("assessing") : t("assess")
					})]
				})]
			});
		}
		/** Render the plugin market Settings tab. */
		function MarketTab({ search, browse, install, uninstall, assess, installed, t }) {
			...
			const busy = busyRow === null ? null : {
				installing: busyAction === "install",
				uninstalling: busyAction === "uninstall",
				assessing: busyAction === "assess"
			};
			const installedRows = installedState ? Object.entries(installedState.sources).map(([dep, src]) => ({
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("button", {
								...
								children: [t("installedTab"), installedState ? `（${installedState.installed.length}）` : ""]
							})
						]
					}),
					...
					view === "browse" ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						browseState.status === "ready" ? (0, react_jsx_runtime.jsxs)("div", {
							...
							}) : browseState.result.plugins.map((p) => PluginRow(p, busy, handleInstall, handleUninstall, handleAssess, t)), allPlugins !== null && browseState.result.plugins.length < filteredList(browseState.result.category).length ? (0, react_jsx_runtime.jsxs)("button", {
								type: "button",
					...
					view === "search" ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						searchState.status === "ready" ? (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								}), searchState.result.local.map((p) => PluginRow(p, busy, handleInstall, handleUninstall, handleAssess, t))] }) : null,
								...
								}), searchState.result.ai.map((p) => PluginRow(p, busy, handleInstall, handleUninstall, handleAssess, t))] }) : null,
					...
					view === "installed" ? (0, react_jsx_runtime.jsxs)("div", {
						...
						}) : null, installedRows.map((p) => PluginRow(p, busy, handleInstall, handleUninstall, handleAssess, t))]
					}) : null
				]
			});
		}
